...
CREATE TABLE "new_Schedule" (
    ...
    "audioSequence" TEXT NOT NULL DEFAULT '',
...
INSERT INTO "new_Schedule" ("audioId", "count", "dayTypeId", "id", "time", "weekDays", "zoneId") SELECT "audioId", "count", "dayTypeId", "id", "time", "weekDays", "zoneId" FROM "Schedule";
DROP TABLE "Schedule";
